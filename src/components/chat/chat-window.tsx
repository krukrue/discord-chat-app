        ...
        <div className="bg-white dark:bg-gray-800 text-black dark:text-white shadow-md rounded-lg p-4 flex flex-col h-[600px] max-h-screen transition-colors">
          ...
          <div className="flex justify-between items-center mb-4 relative">
            ...
            <div className="flex items-center space-x-2 relative">
              ...
              {showOptionsMenu && (
                  <div className="absolute top-8 right-0 bg-white border rounded shadow-md p-3 z-10 space-y-3 w-52 text-sm">

                    {/* Палитра (всегда доступна) */}
                    <div>
                      <label className="block mb-1 text-gray-700">Chat Color:</label>
                    ...
                    {chat.isGroup && (
                        <>
                          <div>
                            <label className="block mb-1 text-gray-700">Change chat image:</label>
                            <input
                                type="file"
                                accept="image/*"
                                onChange={(e) => {
                          ...
                          <div>
                            <button
                                ...
                                className="w-full bg-gray-100 hover:bg-gray-200 px-3 py-1 rounded"
                            >
                              Manage Members
                            </button>
                          </div>
